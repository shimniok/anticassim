...
public class AntiCassimAboutBox extends javax.swing.JDialog {

    public AntiCassimAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(anticassim.AntiCassimApp.class).getContext().getResourceMap(AntiCassimAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(anticassim.AntiCassimApp.class).getContext().getActionMap(AntiCassimAboutBox.class, this);
